    ...
    <div class="col-md-6">
        <div class="article">
            ...
            <dl class="row  text-start">
                ...
                <dt class="col-4 text-end pe-0 <?= hidden($match_data['Squad_prem_max'] == 0); ?>">Prematch:</dt>
                <dd class="col-8 ps-2 <?= hidden($match_data['Squad_prem_max'] == 0); ?>"><?= $match_data['Squad_prem_max'] ?> závodníků</dd>
                ...
                <dt class="d-none col-12 text-center py-3">
    ...
    <div class="col-md-12">
        <div class="article">
            ...
            <ul class="pb-3 text-start">
                ...
                <li>Registrace se uzavírá <?= ($match_data['Zavod_konec_registrace'] == 0) ? 'o půlnoci před registrací' : "$match_data[Zavod_konec_registrace] dny před konáním závodu" ?> (<?= $datumZavod->modify("-$match_data[Zavod_konec_registrace] days")->format('j.n.Y'); ?>).</li>
