...
switch ($dbcreateParam) {
    ...
    Alias varchar(16),
    Prijmeni varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
    ...
    parNote varchar(100) DEFAULT NULL
        ...
        runQuery($query, "Tabulka [$dbcreateTable] byla vytvořena");
        $query = "INSERT into $dbcreateTable (parName,parValue) VALUES ('dbver','2.0')";
