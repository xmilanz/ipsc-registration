...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <input class="form-control" type="text" name="Alias" id="Alias" onkeypress="return avoidspace(event)" placeholder="NovakJ" onfocus="this.placeholder = ''" onblur="this.placeholder = 'NovakJ'" value="<?= htmlspecialchars($line['Alias'], ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="col-md-6 <?= $zavodZbrojniPrukazClass ?>">
        ...
        <input class="form-control" type="text" name="ZP" id="ZP" placeholder="AB 123 456" onfocus="this.placeholder = ''" onblur="this.placeholder = 'AB 123 456'" value="<?= htmlspecialchars($line['ZP'], ENT_QUOTES, 'UTF-8') ?>">
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <select class="form-select" name=Kategorie required>
            <!--option value="<?= htmlspecialchars($line['Kategorie'], ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($line['Kategorie'], ENT_QUOTES, 'UTF-8') ?></option-->
...
<div class="row">
    ...
    <div class="<?= $paymentBeforeClass ?> col-md-6">
    ...
    <div class="col-md-12">
        ...
        <input class="form-control" type="text" name="Poznamka" id="Poznamka" placeholder="Poznámka" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Poznámka'" value="<?= htmlspecialchars($line['Poznamka'], ENT_QUOTES, 'UTF-8') ?>">
    </div>
</div>