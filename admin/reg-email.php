...
// priprava podkladu pro email zavodnikovi
  ...
  $message=$email_registrace_platba_text_admin_resend;
...
$query_odeslano="update ".$table." set PotvrzenoOdeslano='1' where Mail='$_GET[email].' and PotvrzenoOdeslano is null";
$res3=mysql_query($query_odeslano);

  echo "<H3 class=\"nadpis\">Potvrzení registrace</H3>\n";
  echo "<center>Registrační mail byl odeslán na adresu <b>$to</b><br><br>
	$STRELEC_ALIAS<br>
	$STRELEC_SHOOTER<br>
	$STRELEC_DIVISION<br>
	$STRELEC_SQUAD<br><br>
