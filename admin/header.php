    ...
    <div class="container">
        <div class="header">
            <div class="header-logo">
                <div class="logo-left"
                    style="background-image:url('../images/logo-header-<?= $poradatel; ?>.png')">
                </div>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php if ($_SESSION['role'] === 'admin' or $_SESSION['role'] === 'editor'): ?>
                        ...
                        <li class="nav-item dropdown">
                            <button class="btn btn-dark dropdown-toggle ms-3" id="dropdownButton" data-bs-toggle="dropdown" aria-expanded="false">
                                Nastavení závodu
                            </button>
                            <ul class="dropdown-menu">
                                <?php if ($_SESSION['role'] === 'admin'): ?>
                                    <li>
                                        <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#manage_users">
                                            Uživatelé</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item text-danger" href="" data-bs-toggle="modal" data-bs-target="#truncateModal">
                                            Vyprázdnit tabulku závodníků
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <?php endif; ?>
                            <li>
                                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#manage_squads">
                                    Squady
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#manage_divisions">
                                    Divize</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#manage_categories">
                                    Kategorie</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#manage_fee">
                                    Startovné
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#upload_stages">
                                    Nahrání situací
                                </a>
                            </li>
                            </ul>
                        ...
                        <li class="nav-item dropdown">
                            <button class="btn btn-dark dropdown-toggle mx-3" id="dropdownButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                Export
                            </button>
                            <ul class="dropdown-menu">
                                <li>
                ...
                <div class="userArea dropdown me-2">
                    <button class="btn btn-dark custom" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
