                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="form-check-label" for="Web_zobrazovat_situace">
                                                <input type="checkbox" class="form-check-input" id="Web_zobrazovat_situace" name="Web_zobrazovat_situace" <?php if ($match_data['Web_zobrazovat_situace'] == "on") {
                                                    ...
                                                    data-bs-html="true"
                                                    data-bs-title="Zobrazování situací na webu"
                                                    data-bs-content="Pokud se v registraci nebudou zobrazovat obrázky situací, volbu odškrtněte.">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-check-label" for="Zavod_more_divisions">
                                                ...
                                                <a
                                                    ...
                                                    data-bs-placement="top"
                                                    data-bs-html="true"
                                                    data-bs-title="Registrace závodníka do více divizí"
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <fieldset class="border p-3 my-3 rounded">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="Squad_main_max" class="form-label">Squad</label>
                                                    ...
                                                    <div class="invalid-feedback">Nevyplnili jste počet závodníků ve quadu</div>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionMatchConfig">
                                <div class="accordion-body">
                                    ...
                                    <fieldset class="border p-3 my-3 rounded">
                                        <legend class="float-none w-auto px-2 h6">Match director</legend>
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="invalid-feedback">Nevyplnili Match directora</div>
                                            </div>
                                            <div class="col-md-5">
                                    ...
                                    <fieldset class="border p-3 my-3 rounded">
                                        <legend class="float-none w-auto px-2 h6">Range master</legend>
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="invalid-feedback">Nevyplnili Range mastera</div>
                                            </div>
                                            <div class="col-md-5">
