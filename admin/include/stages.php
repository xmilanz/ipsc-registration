<div class="modal fade" id="upload_stages" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel"  aria-hidden="true">
  <div class="modal-dialog modal-notify modal-warning" role="document">
    <!--Content-->
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header bg-success text-center">
        <h4 class="modal-title text-white w-100 font-weight-bold">Nahrání obrázků situací</h4>
								...
								<div class="col-12 col-md-12">  
									<div class="control-group" id="files">  
										<label class="control-label" for="files">  
											<span class='text-primary'><i class='far fa-info-circle pr-2' style='font-size:16px'></i>Soubor musí splňovat tyto parametry:
											<ul>
										...
										<button class="btn btn-primary mt-3 float-right" type="submit" name="SubmitButton">Nahrát</button>  
									</div>  
								</div>  
							</div>  
						</form>  
...
if (isset($_POST['SubmitButton'])) {
    ...
    $statusMessages = []; // Pole pro uchování zpráv
...
//			if (!preg_match('/^stage([1-9]|1[0-9]|20)$/', $fileName)) {
			if (!preg_match('/^stage([1-9]|[1-9][0-9])\.png$/', $fileName)) {
				$statusMessages[] = "<span class='text-danger'>Soubor \"$fileName\" nemá správný název. Použijte názvy stage1.png, stage2.png,...</span>";
				continue;
			}
