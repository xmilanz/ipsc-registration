<div class="modal fade" id="payment_before_on" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel"  aria-hidden="true">
  <div class="modal-dialog modal-notify modal-warning" role="document">
    ...
    <div class="modal-content">
	  ...
	  <div class="col-12">
		<span class="font-weight-bolder">Chcete nastavit závod tak, aby se startovné platilo před závodem?</span><br><i>Výchozí hodnota je 10 dní. Změnit ji můžete v Konfiguraci > Placení závodu</i>
	  </div>
      </div>
	  <!--Body-->
      <!--Footer-->
		<div class="modal-footer border-top-0">
			<button type="submit" class="btn btn-info">Zapnout placení před závodem</button>
	...
	<a href="" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#payment_before_on">Zapnout placení před závodem</a>
