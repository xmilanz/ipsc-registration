            ...
            <form class="row needs-validation" method="post" action="./save.php?new_shooter"  novalidate>
              ...
              <div class="row">
               ...
               <div class="col-md-6 <?php echo "$zavodZbrojniPrukazClass"; ?>">
                  ...
                  <input class="form-control" type="text" name="ZP" id="ZP<?php echo"$i";?>" placeholder="formát AB 123 456" onfocus="this.placeholder = ''" onblur="this.placeholder = 'formát AB 123 456'" >
               </div>
              ...
              <div class="row">
               ...
               <div class="col-md-6">
                 ...
                 <div class=" col-md-6 form-check form-check mt-6">
