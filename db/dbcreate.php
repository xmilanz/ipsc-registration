...
switch ($dbcreateParam) {
  ...
  case "match_config":
    ...
    Zavod_cas_main varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '9:00 - 16:00',
    ...
    Zavod_stats varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'Milan Žídek, Ladislav Novák',
    ...
    Zavod_vysledky varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'https://www.kps-eggenberg.cz/vysledky-eggenberg-cup.php',
    Squad_prem_max int(3) DEFAULT '20',
    Squad_main_max int(3) DEFAULT '10',
    Banka_ucet_CASTKA int(3) DEFAULT '800',
    Banka_ucet_MENA varchar(3) DEFAULT 'CZK',
    Banka_ucet_cislo varchar(20) DEFAULT '296257146',
    Banka_ucet_kod varchar(4) DEFAULT '0300',
    Klub_web varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'https://www.kps-eggnberg.cz',
