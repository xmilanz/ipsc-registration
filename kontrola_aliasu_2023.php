...
<H2>Kontrola aliasů Eggenberg CUP 2023</H2>
<p>Tabulka obsahuje aliasy použité při registraci do <strong>jednotlivých kol</strong> EggenbergCUPu od 2023<br>
<h6><span class='text-danger'>Pro vyhodnocení turnaje je nutné, aby závodník používal stejný alias.</span> Po kontrole prosím pošlete <u><a style="color:#2a5a8e;" href="mailto:milan&#064;g17.cz?subject=Oprava registracnich udaju Eggeneberg CUP 2023">statistikovi email</a></u> s informací, <span class='text-danger'>který alias je správný (= zaregistrovaný na ipsc-tech.org)</span>.</h6/>
<br>
<div class="row">
	<div class="col-md-8">
