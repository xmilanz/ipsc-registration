    ...
    <div class="col-md-6">
        <div class="article">
            ...
            <dl class="row  text-start">
                ...
                <dd class="col-8 ps-2 fw-bold text-uppercase"><?php echo htmlspecialchars($match_data['Zavod'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <dt class="col-4 text-end text-start pe-0">Datum:</dt>
                <dd class="col-8 ps-2"><?php echo htmlspecialchars($match_data['Zavod_datum'], ENT_QUOTES, 'UTF-8'); ?></dd>
                ...
                <dd class="col-8 ps-2"><?php echo /*html*/ "$match_data[Zavod_stages]"; ?></dd>
                <dt class="col-4 text-end pe-0">Min. počet ran:</dt>
                <dd class="col-8 ps-2"><?php echo /*html*/ "$match_data[Zavod_min_pocet_ran]"; ?></dd>
                <dt class="col-4 text-end pe-0 <?php if ($match_data['Squad_prem_max'] == '0') echo /*html*/ "d-none"; ?>">Prematch:</dt>
                <dd class="col-8 ps-2 <?php if ($match_data['Squad_prem_max'] == '0') echo /*html*/ "d-none"; ?>"><?php echo /*html*/ "$match_data[Squad_prem_max]"; ?> závodníků</dd>
                <dt class="col-4 text-end pe-0">Hlavní závod:</dt>
                <dd class="col-8 ps-2"><?php echo /*html*/ "$match_data[Zavod_stages]" * "$match_data[Squad_main_max]"; ?> závodníků</dd>
                <dt class="col-4 text-end text-start pe-0 <?php echo /*html*/ "$registracePozastavena"; ?>">Stav:</dt>
                <dd class="col-8 ps-2 text-danger <?php echo /*html*/ "$registracePozastavena"; ?> ">Pozastavená registrace</dd>
                <dt class="col-4 text-end text-start pe-0">Pořadatel:</dt>
                <dd class="col-8 ps-2"><?php echo htmlspecialchars($match_data['Zavod_poradatel'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <dt class="col-4 text-end text-start pe-0">Místo:</dt>
                <dd class="col-8 ps-2"><?php echo htmlspecialchars($match_data['Zavod_misto'], ENT_QUOTES, 'UTF-8'); ?>&nbsp;&nbsp;<a href='<?php echo htmlspecialchars($match_data['Zavod_misto_mapa'], ENT_QUOTES, 'UTF-8'); ?>' target='_blank' rel='noopener'><i class='fas fa-crosshairs text-dark'></i></a></dd>
                <dt class="col-4 text-end text-start pe-0">Startovné:</dt>
                <dd class="col-8 ps-2"><?php echo ($match_data['Banka_ucet_CASTKA'] == 0 ? 'dle propozic ' . $platba_na_miste : $match_data['Banka_ucet_CASTKA'] . ' ' . $match_data['Banka_ucet_MENA'] . ' ' . $platba_na_miste); ?></dd>
            </dl>
        </div>
    </div>

    <div class="col-md-6">
        <div class="article pb-1 mb-4 <?php if ($match_data['Zavod_zobrazovat_sponzory'] == "") echo /*html*/ "d-none"; ?>">
            <div class="caption mb-2 p-2 ">
...
<div class="row my-3">
    <div class="col-md-6">
        <div class="article">
            ...
            <dl class="row  text-start">
                ...
                <dd class="col-8 ps-2"><?php echo htmlspecialchars($match_data['Zavod_match_director'], ENT_QUOTES, 'UTF-8'); ?></dd>

                <?php if (!empty($match_data['Zavod_email_poradatel'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Email:</dt>
                    <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_email_poradatel'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>

                <?php if (!empty($match_data['Zavod_telefon_poradatel'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Telefon:</dt>
                    <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_telefon_poradatel'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>

                <dt class="col-4 text-end text-start pe-0">Range master:</dt>
                <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_range_master'], ENT_QUOTES, 'UTF-8'); ?></dd>

                <?php if (!empty($match_data['Zavod_email_range_master'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Email:</dt>
                    <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_email_range_master'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>

                <?php if (!empty($match_data['Zavod_telefon_range_master'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Telefon:</dt>
                    <dd class="col-6 ps-2"><?php echo $match_data['Zavod_telefon_range_master']; ?></dd>
                <?php endif; ?>

                <?php if (!empty($match_data['Zavod_stats'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Statistik:</dt>
                    <dd class="col-6 ps-2 "><?php echo htmlspecialchars($match_data['Zavod_stats'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>

                <?php if (!empty($match_data['Zavod_email_stats'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Email:</dt>
                    <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_email_stats'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>

                <?php if (!empty($match_data['Zavod_telefon_stats'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Telefon:</dt>
                    <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_telefon_stats'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>

                <?php if (!empty($match_data['Zavod_hospodar'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Hospodář:</dt>
                    <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_hospodar'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>

                <?php if (!empty($match_data['Zavod_email_hospodar'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Email:</dt>
                    <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_email_hospodar'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>

                <?php if (!empty($match_data['Zavod_telefon_hospodar'])): ?>
                    <dt class="col-4 text-end text-start pe-0">Telefon:</dt>
                    <dd class="col-6 ps-2"><?php echo htmlspecialchars($match_data['Zavod_telefon_hospodar'], ENT_QUOTES, 'UTF-8'); ?></dd>
                <?php endif; ?>
            </dl>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="article">
            ...
            <table class="<?php if ($match_data['Zavod_registrace_pozastaveno'] == "on") echo /*html*/ "d-none"; ?> table table-borderless m-2">
                <tr class="<?php if ($match_data['Squad_prem_max'] == '0') echo /*html*/ "d-none"; ?>""><td><strong>Prematch</strong></td><td><?php echo /*html*/ "$denPrematch " . $datumPrematch->format('j.n.Y') . ""; ?></td><td><?php echo htmlspecialchars($match_data['Zavod_cas_prematch'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
			<tr><td><strong>Prezence</strong></td><td><?php echo /*html*/ "$denZavod " . $datumZavod->format('j.n.Y') . ""; ?></td><td><?php echo htmlspecialchars($match_data['Zavod_cas_prezence'], ENT_QUOTES, 'UTF-8'); ?></td></tr>
			<tr class=" <?php if ($match_data['Zavod_cas_main_dopoledne'] !== '' and $match_data['Zavod_cas_main_odpoledne'] !== '') echo /*html*/ "d-none"; ?>">
                    <td><strong>Závod</strong></td>
                    <td><?php echo /*html*/ "$denZavod " . $datumZavod->format('j.n.Y') . ""; ?></td>
                    <td><?php echo htmlspecialchars($match_data['Zavod_cas_main'], ENT_QUOTES, 'UTF-8'); ?></td>
                </tr>
                <tr class="<?php if ($match_data['Zavod_cas_main_dopoledne'] == '' or $match_data['Zavod_cas_main_odpoledne'] == '') echo /*html*/ "d-none"; ?>">
                    <td><strong>Závod</strong></td>
                    <td><?php echo /*html*/ "$denZavod " . $datumZavod->format('j.n.Y') . ""; ?></td>
                    <td>dopolední směna: <?php echo htmlspecialchars($match_data['Zavod_cas_main_dopoledne'], ENT_QUOTES, 'UTF-8'); ?><br>odpolední směna: <?php echo /*html*/ "$match_data[Zavod_cas_main_odpoledne]"; ?></td></tr-->
    ...
    <div class="col">
        <div class="article">
            ...
            <dl class="row  text-start">
                ...
                <dd class="col-sm-9 text-wrap px-4"><?php echo implode(', ', $zavod_divisions); ?>
                ...
                <dd class="col-sm-9 text-wrap px-4"><?php echo implode(', ', $zavod_categories); ?>
...
<div class="row my-3 <?php if ($match_data['Payment_before'] == "") echo /*html*/ "d-none"; ?> ">
    <div class="col-md-6">
        <div class="article">
            <div class="caption mb-2 p-2">
    ...
    <div class="col-md-6">
        <div class="article">
            ...
            <p class="font-monospace px-3  text-start">Číslo účtu: <?php echo /*html*/ "$match_data[Banka_ucet_cislo]/$match_data[Banka_ucet_kod]"; ?><br>
                Jméno příjemce: <?php echo /*html*/ "$match_data[Zavod_poradatel]"; ?><br>
                Adresa příjemce: <?php echo /*html*/ "$match_data[Zavod_poradatel_adresa]"; ?>
            <p class="font-monospace px-3 pb-3">Banka: <?php echo /*html*/ "$match_data[Banka_nazev]"; ?><br>
                Adresa banky: <?php echo /*html*/ "$match_data[Banka_adresa]"; ?></p>
        </div>
    </div>
</div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <ol>
                                <li>Udělujete tímto dobrovolně souhlas pořadateli <?php echo htmlspecialchars($match_data['Zavod_poradatel'], ENT_QUOTES, 'UTF-8'); ?> (dále jen "Správce"), aby ve smyslu zákona č.101/2000 Sb., o ochraně osobních údajů (dále jen "zákon o ochraně osobních údajů") zpracovávala tyto osobní údaje:
                                    <ul>
