...
$zavod_day = date('l', strtotime($zavod_datum));
switch ($zavod_day) {
...
$zavod_den= $zavod_day . date_format($date,"d. m. Y.");

$prematch_datum = date('d.m.Y', strtotime($zavod_datum . ' -1 day'));
...
$prematch_den= $prematch_day . date_format($date,"d.m.Y.");
...
<div class="row">
	...
	<div class="jumbotron"><H3>Základní informace</H3></div>
		<dl class="row  text-left">
			<dt class="col-4 text-right pr-0">Datum:</dt><dd class="col-8 pl-2"><?php echo "$zavod_datum";?></dd>
			<dt class="col-4 text-right pr-0">Obtížnost:</dt><dd class="col-8 pl-2">IPSC Level I.</dd>
			<dt class="col-4 text-right pr-0">Počet situací:</dt><dd class="col-8 pl-2"><?php echo "$squad_main_stages";?></dd>
			<dt class="col-4 text-right pr-0">Min. počet ran:</dt><dd class="col-8 pl-2"><?php echo "$zavod_min_pocet_ran";?></dd>
			<dt class="col-4 text-right pr-0">Prematch:</dt><dd class="col-8 pl-2"><?php echo "$squad_prem_max závodníků";?></dd>
			<dt class="col-4 text-right pr-0">Hlavní závod:</dt><dd class="col-8 pl-2"><?php echo "$squad_main_pocet_zavodniku závodníků";?></dd>
			<dt class="col-4 text-right pr-0">Pořadatel:</dt><dd class="col-8 pl-2">Klub praktické střelby EGGENBERG</dd>
			<dt class="col-4 text-right pr-0">Místo:</dt><dd class="col-8 pl-2"><a href='https:</b>//goo.gl/maps/ehm6pwDKJbPsvSpB6' target='_new'>střelnice Opařany</a></dd>
			<dt class="col-4 text-right pr-0">Startovné:</dt><dd class="col-8 pl-2"><?php echo "$banka_ucet_CASTKA $banka_ucet_MENA";?></dd>
		</dl>
	</div>
	</div>
	...
	<div class="article">
		...
		<div class="jumbotron border border-left-0 border-right-0 border-bottom-0 border-info"><H3>Bezpečnost</H3></div-->
...
<div class="row my-3">
	...
	<div class="jumbotron"><H3>Vedení závodu</H3></div>
		<dl class="row  text-left">
			<dt class="col-4 text-right pr-0">Match director:</dt><dd class="col-6 pl-2">Antonín Liška (CZE)</dd>
			<dt class="col-4 text-right pr-0">Range Master:</dt><dd class="col-6 pl-2">Ondřej Bárta</dd>
			<dt class="col-4 text-right pr-0">Statistik:</dt><dd class="col-6 pl-2">Milan Žídek, Ladislav Novák</dd>
			<dt class="col-4 text-right pr-0">Kontakt:</dt><dd class="col-6 pl-2">antoni.liska(at)seznam.cz</dd>
			<dt class="col-4 text-right pr-0">Telefon:</dt><dd class="col-6 pl-2">+420 777 286 040</dd>
		</dl>
	</div>
	</div>
	...
	<div class="jumbotron"><H3>Časový plán</H3></div>
		<table class="table table-borderless m-2">
			<tr><td><strong>Prematch</strong></td><td><?php echo "$prematch_den $prematch_datum";?></td><td><?php echo "$zavod_cas_prematch";?></td></tr>
			<tr><td><strong>Prezence</strong></td><td><?php echo "$zavod_den $zavod_datum";?></td><td><?php echo "$zavod_cas_prezence";?></td></tr>
			<tr><td><strong>Závod</strong></td><td><?php echo "$zavod_den $zavod_datum";?></td><td></td></tr>
		</table>
	</div>
</div>
</div>
...
<div class="row my-3">
	...
	<div class="jumbotron"><H3>Další informace</H3></div>
		<dl class="row  text-left">
			<dt class="col-2 text-right pr-1">Divize:</dt><dd class="col-9 pl-2">Open, Standard, Production, Production Optic, Classic, Revolver</dd>
...
<div class="row my-3">
	...
	<div class="jumbotron"><H3>Úhrada startovného</H3></div>
		<ul class="pb-3  text-left">
			...
			<li>Při platbě za více závodníků uveďte pouze jedno číslo a o platbě informujte pořadatele <a href='mailto:registrace&commat;kps-eggenberg.cz'>e-mailem</A>.</b></i>
		</ul>
	</div>
	</div>
	...
	<p class="text-monospace px-3  text-left">Číslo účtu: <?php echo "$banka_ucet";?><br>
...
<div class="row my-3">
	...
	<ol>
		<li>Udělujete tímto dobrovolně souhlas pořadateli <?php echo "$gdpr_spravce";?> (dále jen "Správce"), aby ve smyslu zákona č.101/2000 Sb., o ochraně osobních údajů (dále jen "zákon o ochraně osobních údajů") zpracovávala tyto osobní údaje:
			<ul>
