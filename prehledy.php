...
$paidOnly = !empty($match_data['Payment_before']);
...
<div class="row pl-3 pt-3">
    ...
    ");
        ...
        $stmt = $conn->prepare("
        SELECT Kategorie,count(Alias) as Count FROM $table    
        where Squad >= 100 and Zaplaceno='on' GROUP BY Kategorie HAVING count(Alias)>=1 ORDER BY Kategorie
    ");
    }
    $stmt->execute();
    $result = $stmt->get_result();
